...
public class Utils {
	      ...
	      for (Board board : boards) {
	         ...
	         if (thumbnail.equals("")) {
	            if (et != null) {
	               ...
	               board.setPreviewImg("/blog/util/img/home-blog/blog-1.jpg");
	            }
	         }
	      }
	   }
		...
		if(ets != null) {
			for(Element et : ets) {
				...
				if(href.contains("https://www.youtube.com/watch") && !et.text().equals("")) {
					...
					String iframe ="<iframe src='https://www.youtube.com/embed/"+v+"' width='600px' height='350px' allowfullscreen='true'/>";
					et.after(iframe);
					board.setContent(doc.toString());
	...
	@Test
	public void setPreviewYoutubeTest() {
		String content = "<a href = 'https://www.youtube.com/watch?v=CL3nhYJwgeU'>https://www.youtube.com/watch?v=CL3nhYJwgeU</a>";
	...
	/*
	 * @Test public void previewContentTest() {
	 * 
	 * String content = ""; Document doc = Jsoup.parse(content);
	 * System.out.println(doc);
	 * 
	 * 
	 * Elements ets = doc.select("img"); System.out.println();
	 * 
	 * if(ets != null) { for(Element et : ets) { et.remove(); }
	 * System.out.println(doc); } }
	 */
