...
public class ReplyDao {
   ...
   public Reply findByMaxId() {
      ...
      sb.append("select r.id, r.commentId, r.userId, r.content, r.createDate, u.id, u.username, u.userProfile ");
      ...
      try {
         ...
         if(rs.next()) {
            ...
            reply.getUser().setId(rs.getInt("u.id"));
   ...
   public int deleteAll(int id) {
	      ...
	      final String SQL = "DELETE FROM reply WHERE commentid = ?";
	      conn = DBConn.getConnection();
