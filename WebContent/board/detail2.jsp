...
<body>
						...
						<div class="user_details">
							...
							<div class="float-right">
								<div class="media">
									...
									<div class="d-flex">
										<img src="util/img/blog/user-img.jpg" alt="">
									</div>
								</div>
							</div>
						</div>
						...
						<c:forEach var="comment" items="${comments}">
							...
							<div class="comment-list" id="comment-id-${comment.id}">
								...
								<div class="reply-btn float-right">
									...
									<button id="showreply${comment.id}" onClick="replyListShow(${comment.id})" value="a" class="btn-reply text-uppercase">
										<i class="fa fa-file" style="font-size: 18px;"></i>
									</button>
									<button id="replyForm${comment.id}" onClick="replyWriteShow(${comment.id})" value="a" class="btn-reply text-uppercase">
								...
								<div class="single-comment justify-content-between d-flex">
									<div class="user justify-content-between d-flex">
										<div class="thumb">
											<img src="/blog/util/img/blog/c1.jpg" alt="">
										</div>
										<div class="desc">
											<h5>
	...
	function commentItemForm(id, username, content, createDate){
	    ...
	    commentItem += "<div class='thumb'> <img src='/blog/util/img/blog/c1.jpg' alt=''> </div> ";
	...
	function replyItemForm(id, username, content, createDate){
		...
		replyItem+= "<div class='thumb'><img src='/blog/util/img/blog/c2.jpg' alt=''></div>";
	...
	function commentWrite(){
		...
		$.ajax({
			...
			success: function(comment){
				...
				$("#comments-area").after(comment_et);
				//입력폼 초기화하기
				$("#comment-content").val("");
