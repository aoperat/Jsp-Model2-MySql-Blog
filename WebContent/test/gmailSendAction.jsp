...
<%
		String host = "http://localhost:8080/blog/test/";		
		String from = "aoperat@gmail.com";
		User user = new User();
		user = (User)request.getAttribute("user");
		String to = user.getEmail();
		String username = user.getUsername();
		System.out.println("겟 어트리뷰트 되는지 확인 : " +to);
		String code = SHA256.getEncrypt(to, "cos");

		//사용자에게 보낼 메시지
		String subject = "회원가입을 위한 이메일 인증 메일입니다.";
		String content = "다음 링크에 접속하여 이메일 인증을 진행해주세요. " 
		        + "<a href='" + host + "gmailCheckAction.jsp?code=" + code+"&email="+to+"&username="+username
				+ "'>이메일 인증하기</a>";
